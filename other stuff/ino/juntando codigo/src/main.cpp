...
void actualizar_MEF()
{
  switch (Menu_principal)
  {
    case estado_standby:
      void tomar_temperatura();
    case estado_inicial:
      /*lcd.print("Calefaccion manual");*/ lcd.setCursor(0,3); lcd.print("Calefaccion automatica"); //lcd.setCursor(0,3); lcd.print("Carga por hora"); lcd.setCursor(5,3); lcd.print("Carga por nivel"); lcd.setCursor(16,3); lcd.print(Sensor_temp.getTempCByIndex(0));
